...
*/
func (a *SystemAPIService) ApiMetrics(ctx context.Context, name string) ApiApiMetricsRequest {
	return ApiApiMetricsRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *SystemAPIService) ApiMetricsExecute(r ApiApiMetricsRequest) (*LinkListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SystemAPIService.ApiMetrics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
