...
func (o *RunnerInfo) GetCreateTime() time.Time {
...
// and a boolean to check if the value has been set.
func (o *RunnerInfo) GetCreateTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreateTime) {
		return nil, false
	}
...
func (o *RunnerInfo) HasCreateTime() bool {
	if o != nil && !IsNil(o.CreateTime) {
		return true
	}
...
func (o *RunnerInfo) SetCreateTime(v time.Time) {
	o.CreateTime = &v
}
